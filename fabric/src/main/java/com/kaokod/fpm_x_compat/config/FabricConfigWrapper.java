...
public class FabricConfigWrapper implements FpmXCompatConfigValues {
    
    // Hardcoded defaults for Fabric temporarily until ClothConfig JSON serialization is fully implemented.
